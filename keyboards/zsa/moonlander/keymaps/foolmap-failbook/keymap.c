 ...
 * +-------+-------+-------+-------+---------+-------+               +-------+----------+-------+-------+-------+-------+
 * | ^LGUI | HOME  | PGUP  | PGDN  |~LGUI,END| @SYMB |               | @SYMB |~RGUI,LEFT| DOWN  |  UP   | RIGHT | ^RGUI |
 * +-------+-------+-------+-------+---------+-------+               +-------+----------+-------+-------+-------+-------+
...
[BASE] = LAYOUT_moonlander(
        ...
        OSM(MOD_LGUI), KC_HOME,       KC_PGUP,       KC_PGDN,       MT(MOD_LGUI, KC_END), OSL(SYMB), OSL(SYMB),     MT(MOD_RGUI, KC_LEFT), KC_DOWN, KC_UP, KC_RIGHT, OSM(MOD_RGUI),
 ...
 * |       |       |       |       |         |       |       |       |       |          |       |       |       |       |
 * +-------+-------+-------+-------+---------+-------+-------+-------+-------+----------+-------+-------+-------+-------+
 * |       |  WHU  |  WHL  |  MSU  |   WHR   |       |       |       | BTN2  |   ACL0   |  UP   | ACL1  | ACL2  |       |
 * +-------+-------+-------+-------+---------+-------+-------+-------+-------+----------+-------+-------+-------+-------+
 * |       |  WHD  |  MSL  |  MSD  |   MSR   |       |       |       | BTN1  |   LEFT   | DOWN  | RIGHT |       |       |
 * +-------+-------+-------+-------+---------+-------+-------+-------+-------+----------+-------+-------+-------+-------+
...
[MDIA] = LAYOUT_moonlander(
        ...
        _______, KC_WH_U, KC_WH_L,  KC_MS_U, KC_WH_R, _______, _______, _______, KC_BTN2, KC_ACL0, KC_UP,   KC_ACL1,  KC_ACL2, _______,
        _______, KC_WH_D, KC_MS_L,  KC_MS_D, KC_MS_R, _______, _______, _______, KC_BTN1, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
...
[THDF] = LAYOUT_moonlander(
        ...
        _______, _______,       _______, _______, _______,       _______, _______, _______,   _______, _______, _______, _______, _______, _______,
        _______, _______,       _______, _______, _______,       _______, _______, _______,   _______, _______, _______, _______,
        _______, _______,       _______, _______, OSL(MDIA),     _______, _______, OSL(MDIA), _______, _______, _______, _______,
